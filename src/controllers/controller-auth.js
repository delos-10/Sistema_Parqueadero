...
function iniciarSesion() {
  ...
  if (datos.rol !== rolSeleccionado) {
    mostrarErrorLogin(
      `❌ Este usuario no es un ${rolSeleccionado}. Selecciona el rol correcto.`,
    );
    return;
  }
...
const CARDS_USUARIO = [
  ...
  "cardMiVehiculo",
  "cardMisReservas",
  "cardHistorialUsuario",
];
const CARDS_OPERADOR = [
  "cardRegistroVehiculos",
  "cardVehiculosActivos",
  "cardReservasActuales",
  "panelOperador",
  "cardHistorial",
];
